            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <Reveal>
                    <h1 className="text-4xl md:text-5xl font-extrabold mb-6 text-gray-900">
                        Broker Platform — Real Estate Engine
                    </h1>
                </Reveal>
                ...
                <Reveal delay={0.15}>
                    <p className="text-lg text-gray-600 max-w-3xl">
                        A clean, modern, high-speed real estate listing engine designed for
                ...
                <div className="mt-12 grid md:grid-cols-2 gap-10">
                    ...
                    <RevealRight delay={0.25}>
                        <div className="p-6 rounded-xl bg-white shadow-lg border border-gray-200">
                            ...
                            >
                                <Home className="w-12 h-12 text-blue-600 mb-3" />
                            </motion.div>

                            <h3 className="font-bold text-xl">Perfect For</h3>
                            <p className="text-gray-600 mt-3">
                                Independent brokers, small real estate teams, micro realty firms.
                            </p>
                        </div>
                    </RevealRight>
                ...
                <Reveal delay={0.35}>
                    <div className="mt-12 flex gap-4">
                        <a
                            href="?type=demo&product=broker app#contact"
                            className="px-6 py-3 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700"
                        >
                            Request Demo
                        </a>
                        <a
                            href="?type=white-label&product=broker app#contact"
